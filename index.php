...
<html lang="en">
	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>AgroBuzz</h2>
						<p>Explore the new way of Market...</p>
					</header>
					<div class="row 200%">
		...
		<center>
			<h1 style="font: 35px arial ;">About Us</h1>
		</center>
		<div class="footer-left">
			<h3 style="font-family: 'Helvetica';">AgroBuzz &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Buzz Fam<span>India</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agrobuzz@gmail.com" style="color:white">yourmail@somemail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About AgroBuzz</b></span>
				AgroBuzz is e-commerce trading platform for grains & grocerries...
			</p>
